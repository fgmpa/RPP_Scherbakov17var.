    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliate', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.affiliate')),
            ],
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
                ...
                ('office', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.office')),
            ],
        ),
        migrations.CreateModel(
            name='Worker_room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_workplace', models.BooleanField()),
                ('room', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.room')),
                ('worker', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
